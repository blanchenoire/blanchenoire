...
export default function Checkout() {
    ...
    return (
        <>
            <Navbar />
            <div className="grid gap-10 px-[6%] py-12 text-[#f8efe5] lg:grid-cols-3">
                ...
                <div className="lg:col-span-2 space-y-10">
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            {cartItems.map((item) => (
                                <div key={item.id} className="theme-card flex items-center gap-4 rounded-2xl p-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-[#f0bf70]">Rs. {item.Product.price}</p>
                                    </div>

                                    <div className="glass-button flex items-center rounded-full px-3">
                    ...
                    <div>
                        ...
                        {/* Fixed container */}
                        <div className="theme-card flex h-[300px] flex-col rounded-2xl p-4">
                            ...
                            <div className="flex-1 overflow-y-auto space-y-3 pr-2">
                                {visibleAddresses.map((addr) => (
                                    <div
                                        key={addr.id}
                                        className={`flex items-start justify-between rounded-2xl border border-white/12 p-4 ${selectedAddress === addr.id ? "bg-white/12" : ""
                                            }`}
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            <div>
                                                <p className="font-medium">
                                                    {addr.name}
                                                    {addr.isDefault && (
                                                        <span className="ml-2 rounded bg-white px-2 py-1 text-xs text-[#102033]">
                                                            Default
                                                        </span>
                                                    )}
                                                </p>
                                                <p className="text-sm text-white/62">{addr.address}</p>
                            ...
                            <div className="mt-3 space-y-2 border-t border-white/12 pt-3">
                                ...
                                {addresses.length > 2 && (
                                    <button
                                        ...
                                        className="text-sm text-[#f0bf70] hover:underline"
                                    >
                                ...
                                <div
                                    ...
                                    className="flex cursor-pointer items-center justify-center rounded-xl border-2 border-dashed border-white/18 py-2"
                                >
                                    + Add New Address
                                </div>
                ...
                {/* RIGHT */}
                <div className="glass-panel sticky top-10 h-fit rounded-2xl p-6">
                    ...
                    <hr className="my-4 border-white/12" />
                    ...
                    <button onClick={handleProceedButton} className="w-full rounded-full bg-white py-3 font-bold text-[#102033]">
                        Proceed to Payment
                    </button>
                ...
                {openModal && (
                    ...
                    >
                        <div
                            className="glass-panel w-[420px] rounded-[28px] p-6"
                            onClick={(e) => e.stopPropagation()}
                        >
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-3">
                                <input
                                    ...
                                    className="theme-input rounded-xl p-2"
                                />
                                <input
                                    name="phone"
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                placeholder="Address"
                                className="theme-input mb-3 w-full rounded-xl p-2"
                            />
                            ...
                            <input
                                ...
                                className="theme-input mb-4 w-full rounded-xl p-2"
                            />
                            ...
                            <div className="flex justify-end gap-3">
                                ...
                                <button
                                    ...
                                    className="rounded-full bg-white px-5 py-2 font-bold text-[#102033]"
                                >
                                    Save Address
                                </button>
                            </div>
