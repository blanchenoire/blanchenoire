...
export default function TermsPage() {
  return (
    <div className="theme-page">
      ...
      <main className="px-4 pb-16 pt-36 sm:px-[6%] md:pb-24">

        {/* HEADER */}
        <div className="mb-14 max-w-5xl">
          <h1 className="font-display mb-4 text-[46px] font-bold uppercase leading-tight text-white md:text-[76px]">
            Terms & Conditions
          </h1>
        ...
        {/* CONTENT */}
        <div className="glass-panel max-w-5xl space-y-12 rounded-[34px] p-7 text-sm leading-relaxed text-white/68 md:p-10 md:text-base">
